...
public class IncomingCallScreenActivity extends BaseActivityCalling {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GlideApp.with(this).asBitmap().load(callerImage).dontAnimate().diskCacheStrategy(DiskCacheStrategy.ALL).into(profileImage);
    ...
    private void answerClicked() {
        ...
        if (call != null) {
            ...
            intent.putExtra("recepientname", mCallername);
            intent.putExtra("recepientImage", callerImage);
