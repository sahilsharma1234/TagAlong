...
//        googleMap.setMapStyle(style);
    ...
    public void setDestinationLatLong(LatLng endTripLatLng) {

        destination = endTripLatLng;
    }

    public void setSourceLatLong(LatLng startTripLatLng) {

        source = startTripLatLng;
    }
