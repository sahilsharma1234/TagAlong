...
public class TrackRiderActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapFragment.getMapAsync(TrackRiderActivity.this);
        ...
        sendReportActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(TrackRiderActivity.this, SendReportActivity.class);
